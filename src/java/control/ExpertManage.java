...
public class ExpertManage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExpertManage</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExpertManage at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao dao = new dao();
        Expert expert = dao.getExpertById(expertID);
        Map<Integer, List<String>> expertCategories = dao.categoriesExpert();
        Map<Integer, List<Course>> courseExpert = dao.expertCoures();
        List<Category> cate = dao.getCategories();
        ...
        request.getRequestDispatcher("ExpertManage.jsp").forward(request, response);
    }
