    ...
    <div class="login-container">
        <div class="bg-white rounded p-5">
            ...
            <div class="text-center mb-3">
                <p>Or login with</p>
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/SWP391_Group5(me)/LoginGoogle&response_type=code&client_id=826239897772-hjalfh6l6mrrl73029j0fqs9lis7ffjo.apps.googleusercontent.com&access_type=online&prompt=consent" class="btn btn-danger w-100 mb-2">Login with Google</a>
            </div>
