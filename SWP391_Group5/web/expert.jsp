            ...
            %>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 shadow">
                        <a href="ExpertViewProfile?user_id=<%= loggedInUser.getUserId() %>" class="dropdown-item">View Profile</a>
                        <a href="ExpertEditProfile?user_id=<%= loggedInUser.getUserId() %>" class="dropdown-item">Edit Profile</a>
