...
<body>
    <div class="container" style="margin-top: 10px;">
        <div class="row" style="border: 1px darkgrey solid; border-radius: 10px; width: 50%; margin: 0 auto; padding: 20px;">
            <div class="col-sm-12">
                <h2 class="myClass">Upload Video</h2>
                ...
                <form action="uploadVideo" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control" name="youtubeLink" placeholder="Enter YouTube link" required>
                        <!-- Warning message for YouTube link -->
                        <p class="text-warning" style="margin-top: 5px;">Please ensure the YouTube link is set to Private mode.</p>
                    </div>
