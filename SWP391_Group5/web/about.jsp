   ...
   <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <form action="ExpertDetailControl" method="post">
                                <input type="hidden" name="expertID" value="<%= expert.getExpertId() %>">
                                <button type="submit" style="border: none; background: none; padding: 0;">
                                    <img class="img-fluid" src="<%= user.getImage() != null ? user.getImage() : "img/default.jpg" %>" alt="">
                                </button>
                            </form>
                        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <% 
                    ArrayList<Expert> expertListt = (ArrayList<Expert>) request.getAttribute("expertList");
                   
                        for (Expert expert : expertListt) {
                            Users user = expert.getUser();
                %>
