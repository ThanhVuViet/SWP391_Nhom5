...
public class adminDashboard extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int totalCourses = dao.getCourseRegistrationCountToday();
        int totalUsers = dao.getUserRegistrationCountToday();
        double totalRevenue = dao.getTotalRevenueToday();
        int totalFeedbacks = dao.getFeedbackCountToday();
